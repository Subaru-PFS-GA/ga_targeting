...
config = dict(
    ...
    netflow_options = dict(
        ...
        # lambda expression. Defining this parameter is currently not supported in
        # configuration formats other than python.
        #
        ...
        # expression. Defining this parameter is currently not supported in configuration
        # formats other than python.
        #
