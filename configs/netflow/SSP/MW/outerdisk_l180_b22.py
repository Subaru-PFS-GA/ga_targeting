...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerdisk_l180_b22_SSP'
...
config = dict(
    field = dict(
        ...
        name = "GA Outer Disk l=180 b=22 Faint",
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerdisk_l180_b22_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l180b22_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l180b22_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
