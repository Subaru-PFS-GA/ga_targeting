...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerdisk_l180_b29_SSP'
...
config = dict(
    field = dict(
        key = "outerdisk_l180_b29_faint",
        name = "GA Outer Disk l=180 b=29 Faint",
        obs_time = datetime(2025, 11, 18, 13, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=119.55, dec=40.15, posang=120.0, priority=1),
    ],
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerdisk_l180_b29_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l180b29_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l180b29_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
