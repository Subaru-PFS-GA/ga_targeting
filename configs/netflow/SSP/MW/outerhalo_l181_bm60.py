...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerhalo_l181_bm60_SSP'
...
config = dict(
    field = dict(
        key = "outerhalo_l181_bm60_faint",
        name = "GA Outer Halo l=181 b=-60 Faint",
        obs_time = datetime(2026, 1, 27, 6, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=38.202654, dec=-9.04607231, posang=120.0, priority=1),
    ],
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerhalo_l181_bm60_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l181b-60_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l181b-60_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
            ...
            mask = 'lambda df: df["prob_f_star"] > 0.4',
            prefix = "cal",
            catid = CATID_FLUXSTD,
            extra_columns = {
                **{
