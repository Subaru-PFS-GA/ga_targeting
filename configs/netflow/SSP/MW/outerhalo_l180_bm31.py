...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerhalo_l180_bm31_SSP'
...
config = dict(
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerhalo_l180_bm31_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l180b-31_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l180b-31_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
