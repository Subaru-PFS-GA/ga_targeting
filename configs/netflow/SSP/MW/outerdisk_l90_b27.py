...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerdisk_l90_b27_SSP'
...
config = dict(
    field = dict(
        key = "outerdisk_l90_b27_faint",
        name = "GA Outer Disk l=90 b=27 Faint",
        obs_time = datetime(2025, 6, 30, 12, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=276.3, dec=60.7, posang=120.0, priority=1),
    ],
    targets = {
        # # Federico
        # "pristine": dict(
        #     path = f'{DATA_DIR}/Pristine_synth_273.5_60.9.csv',
        #     prefix = "sci",
        ...
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerdisk_l90_b27_faint.ecsv',
        ...
        # # Roman
        # "anc": dict(
        #     path = f'{DATA_DIR}/may_274_61.feather',
        #     reader_args = dict(),
        ...
        # Miho
        "sky": dict(
            path = f'{DATA_DIR}/l90b27_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        # Miho
        "fluxstd": dict(
            path = f'{DATA_DIR}/l90b27_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
