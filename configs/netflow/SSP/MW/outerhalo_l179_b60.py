...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerhalo_l179_b60_SSP'
...
config = dict(
    field = dict(
        key = "outerhalo_l179_b60_faint",
        name = "GA Outer Halo l=179 b=60 Faint",
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerhalo_l179_b60_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l179b60_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l179b60_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
