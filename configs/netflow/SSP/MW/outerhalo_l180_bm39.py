...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerhalo_l180_bm39_SSP'
...
config = dict(
    field = dict(
        key = "outerhalo_l180_bm39_faint",
        name = "GA Outer Halo l=180 b=-39 Faint",
        obs_time = datetime(2026, 1, 27, 6, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=53.5362, dec=4.9039, posang=120.0, priority=1),
    ],
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerhalo_l180_bm39_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l180b-39_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l180b-39_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
