...
config = dict(
    ...
    pointings = [
        dict(ra=340.4, dec=26.50, posang=120.0, priority=2),
    ],
    ...
    targets = {
        # Federico
        "jplus": dict(
            path = f'{DATA_DIR}/JPLUS_340.4_26.5.csv',
            prefix = "sci",
        ...
        # Federico
        "pristine_dr1": dict(
            path = f'{DATA_DIR}/Pristine_DR1_340.4_26.5.csv',
            prefix = "sci",
            catid = CATID_SCIENCE_GA,
            priority = 0,
            column_map = {
        ...
        # Federico
        "pristine_synth": dict(
            path = f'{DATA_DIR}/Pristine_synth_340.4_26.5.csv',
            prefix = "sci",
            catid = CATID_SCIENCE_GA,
            priority = 0,
            column_map = {
        ...
        # Roman
        "anc": dict(
            path = f'{DATA_DIR}/may_340_26.feather',
            reader_args = dict(),
