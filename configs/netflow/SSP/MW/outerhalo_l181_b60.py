...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerhalo_l181_b60_SSP'
...
config = dict(
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerhalo_l181_b60_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l181b60_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l181b60_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
