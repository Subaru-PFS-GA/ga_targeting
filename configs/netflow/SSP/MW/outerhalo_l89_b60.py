...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/MW/outerhalo_l89_b60_SSP'
...
config = dict(
    field = dict(
        key = "outerhalo_l89_b60_faint",
        name = "GA Outer Halo l=89 b=60 Faint",
        obs_time = datetime(2026, 3, 17, 6, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=218.3218, dec=49.9618, posang=100.0, priority=1),
    ],
    ...
    targets = {
        # Miho
        "ps1": dict(
            path = f'{DATA_DIR}/ga_targets_outerhalo_l89_b60_faint.csv',
        ...
        "sky": dict(
            path = f'{DATA_DIR}/l89b60_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        "fluxstd": dict(
            path = f'{DATA_DIR}/l89b60_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
