...
config = dict(
    ...
    pointings = [
        dict(ra=288.00, dec=-16.75, posang=0.0, priority=9),
    ],
    targets = {
        # Miho
        "gaia": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-17.ecsv',
        ...
        # Federico
        "pristine": dict(
            path = f'{DATA_DIR}/Pristine_synth_288.1_-16.7.csv',
            prefix = "sci",
            catid = CATID_SCIENCE_GA,
            priority = 0,
            column_map = {
        ...
        # Miho
        "sky": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-17_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        # Miho
        "fluxstd": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-17_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
