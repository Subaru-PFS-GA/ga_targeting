...
config = dict(
    ...
    pointings = [
        dict(ra=287.75, dec=-22.20, posang=0.0, priority=100),
    ],
    targets = {
        # Miho
        "gaia": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-22.ecsv',
        ...
        # Federico
        "pristine": dict(
            path = f'{DATA_DIR}/Pristine_synth_287.7_-22.4.csv',
            prefix = "sci",
            catid = CATID_SCIENCE_GA,
            priority = 0,
            column_map = {
        ...
        # Miho
        "sky": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-22_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        # Miho
        "fluxstd": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-22_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
