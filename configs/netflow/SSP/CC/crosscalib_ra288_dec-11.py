...
config = dict(
    ...
    pointings = [
        dict(ra=288.35, dec=-11.45, posang=120.0, priority=0),
    ],
    targets = {
        # Miho
        "gaia": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-11.ecsv',
        ...
        # Federico
        "pristine": dict(
            path = f'{DATA_DIR}/Pristine_synth_288.4_-11.4.csv',
            prefix = "sci",
            catid = CATID_SCIENCE_GA,
            priority = 0,
            column_map = {
        ...
        # Miho
        "sky": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-11_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        # Miho
        "fluxstd": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra288_dec-11_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
