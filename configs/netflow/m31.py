...
PFSPATH="/raid/pfs" #os.environ['PFS_DATA_DIR']

config = dict(
    targets = {
        "dsph": dict(
            path = PFSPATH+"/data/targeting/m31/m31_obs.feather",
            # reader = None
            reader_args = dict(),
        ...
        "sky": dict(
            path = PFSPATH+"/data/targeting/m31/sky_m31.feather",
            reader_args = dict(),
            column_map = {
                'sky_id': 'targetid',
                'ra': 'RA',
        ...
        "fluxstd": dict(
            path = PFSPATH+"/data/targeting/m31/fluxstd_m31.feather",
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'ra': 'RA',
