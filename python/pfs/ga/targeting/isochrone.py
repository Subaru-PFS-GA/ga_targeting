...
class Isochrone(DiagramValueProvider):
    ...
    def from_isogrid(self, photometry, isogrid: IsoGrid, Fe_H, log_t, M_ini=None, DM=None, name_mappings=None, **kwargs):
        """
        Creates an isochrone instance from a an isochrone grid using the cmdfit library.
        """

        # TODO: write a version which takes EEP limits instead of M_ini
        ...
        _, _, iso_values, iso_mask = isogrid.interp3d(iso_Fe_H, iso_log_t, iso_M_ini, values=values)
