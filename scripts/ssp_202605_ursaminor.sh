...
# This script is specifically for generating the Stage 1 designs with updated
# priorities. The new priorities are generated by the updates ga-sample script but
# the number of done visits had to be "manually" updated based on the obs logs
# after the target lists have been imported with ga-import.
...
NFRAMES=2
EXP_TIME=1800
OBS_TIME="2026-05-10T10:00:00"          # UTC, 12am in Hawaii
OBS_RUN="2026-05"
...
# for stage in $STAGES; do
#     indir=${FIELD_DIR}/netflow/${PREFIX}/${FIELD}_${NVISITS}_${stage}_${VERSION}
#     outdir=${FIELD_DIR}/catalog/${PREFIX}/${FIELD}_${NVISITS}_${stage}_${VERSION}
#     if [ ! -d "$outdir" ]; then
#         ga-catalog --dsph ${FIELD} \
#             --config \
#                 ./configs/netflow/${PREFIX}/dSph/_common.py \
#                 ./configs/netflow/${PREFIX}/dSph/${FIELD}.py \
#             --in ${indir} \
